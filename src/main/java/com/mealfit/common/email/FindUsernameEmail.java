...
public class FindUsernameEmail implements SendingEmailStrategy {
    ...
    public FindUsernameEmail(String url, String maskedUsername) {
        this.url = url;
    ...
    public void fillMessage(MimeMessage message) {
        try {
            ...
            message.setText(new StringBuffer()
                  ...
                  .append("        </h1>\n")
                  .append("        <h2 class=\"Title\" style=\"margin: 0; font-family: 'GmarketSans'; box-sizing: border-box; text-decoration: none; color: inherit; margin-top: 12px; font-size: 26px;\"><span class=\"another\" style=\"margin: 0; font-family: 'GmarketSans'; box-sizing: border-box; text-decoration: none; color: #FF7770;\">아이디 찾기</span> 안내</h2>\n")
                  .append("    </header>\n")
                  ...
                  .append("        <p class=\"content-text\" style=\"font-family: 'GmarketSans'; box-sizing: border-box; text-decoration: none; color: inherit; margin: 0 0 30px; font-size: 18px; line-height: 1.6;\">\n")
                  ...
                  .append("            아래 <span class=\"another\" style=\"margin: 0; font-family: 'GmarketSans'; box-sizing: border-box; text-decoration: none; color: #FF7770;\">'로그인 하기'</span> 버튼을 클릭하여 로그인을 진행해주세요.<br style=\"margin: 0; font-family: 'GmarketSans'; box-sizing: border-box; text-decoration: none; color: inherit;\">\n")
                  .append("            로그인을 하지 않을 시, 밀핏(Mealfit)의 일부 서비스가 제한됩니다.<br style=\"margin: 0; font-family: 'GmarketSans'; box-sizing: border-box; text-decoration: none; color: inherit;\">\n")
                  .append("            감사합니다.\n")
                  .append("        </p>\n")
                  .append("        <p class=\"info\" style=\"margin: 0; font-family: 'GmarketSans'; box-sizing: border-box; text-decoration: none; color: #fff; width: 20%; border-radius: 6px; margin-right: 15px; height: 50px; background-color: #FF7770; text-align: center; line-height: 50px; display: inline-block;\">아이디</p>\n")
